...
public class SchoolpageApplication {
	...
	public CommandLineRunner initData(UsuarioRepository usuarioRepository, MateriaRepository materiaRepository, ContenidoRepository contenidoRepository,
		...
		return (args) -> {
			...
			//-------------------------------------Materias-------------------------------------------------
			Materia matematica = new Materia("Matematica", "Estudio del razonamiento lógico y analítico, abordando números, álgebra, geometría y más, para resolver problemas cotidianos y científicos.", "https://cdn-blog.superprof.com/blog_co/wp-content/uploads/2020/10/las-matematicas.jpeg", "#a1d9d9" );
			Materia quimica = new Materia("Quimica", "Ciencia que estudia la composición, estructura y transformación de la materia, aplicándose en la salud, industria, medio ambiente y tecnología.", "https://cards.algoreducation.com/_next/image?url=https%3A%2F%2Ffiles.algoreducation.com%2Fproduction-ts%2F__S3__85d3dd80-4e5e-4469-961c-a4b3a1814e27&w=3840&q=75", "#a2b38b");
