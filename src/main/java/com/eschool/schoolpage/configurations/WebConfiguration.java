    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(authorize ->
                                authorize
                                        .requestMatchers("/api/materias/", "/api/materias/*","/api/materias/mysubjects", "/api/materias/availablesubjects", "/api/usuarios/leaveSubject","api/notificacion/",
                                                "api/notificacion/markAsViewed/**", "api/notificacion/clean", "/api/usuarios/configuration", "/api/auth/current", "/api/contenido/*", "/api/comentario/*",
                                                "/api/respuesta/fromAcomment/*").hasAnyRole("ALUMNO","PROFESOR", "ADMIN")
